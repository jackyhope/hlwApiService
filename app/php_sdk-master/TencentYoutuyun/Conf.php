...
class Conf
{
    ...
    public static $APPID = '10119662';
    public static $SECRET_ID = 'AKIDQlurdED9ZpywkPrJYbN6dzA8tS9hrgGe';
    public static $SECRET_KEY = 'LUSHUaWHsHVZRTL2tsnbEi062xlT4Til';
    public static $END_POINT = 'http://api.youtu.qq.com/';


    // 开发者 QQ
    public static $USER_ID = '2556025259';
